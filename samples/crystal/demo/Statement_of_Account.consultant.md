...
**1. ℹ [pages] the conversion is more compact: 58 pages vs 74 - the original leaves near-empty spill pages (43 of them) that the conversion consolidates; every statement still spans the same pages as the original**
   - *No automatic resolution - consultant judgment needed.*

**2. ⚠ [appearance] REPORT-WIDE: the middle of the page differs on 58 of the 58 page(s) compared. It is one difference in a band that repeats, not one per page - a single fix covers every statement**
