...
150 reports scanned from `samples/crystal/real`. A report demonstrating several features appears in several folders - pick demo reports by the feature you want to show.
...
| `sort-directions/` | explicit record/group sort fields | 19 |
| `images/` | picture objects | 44 |
| `manual-formulas/` | formulas needing the LLM or a human | 37 |
| `linked-tables/` | no SQL command - the query is generated from the layout | 118 |
| `sql-commands/` | verbatim SQL command objects | 32 |
